              ...
              <View style={styles.mainCell}>
                <View style={styles.leftCell}>
                  ...
                  <Text style={styles.duration} numberOfLines={1}>
                    {moment(this.props.event.duration.startAt).format('DD/MM HH:mm') + ' - ' + moment(this.props.event.duration.finishAt).format('DD/MM HH:mm')}
                    {' '}({moment.duration(moment(this.props.event.duration.finishAt).diff(this.props.event.duration.startAt)).asMinutes()} minut)
                  </Text>
